      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b border-slate-200 bg-gradient-to-b from-slate-50 via-white to-white">
          ...
          <div className="container relative flex flex-col items-center py-10 text-center md:py-14">
            ...
            <div aria-hidden="true" className="pointer-events-none absolute bottom-[14%] left-[10%] hidden animate-float [animation-delay:2s] md:block">
              <div className="relative h-12 w-12 -rotate-3 rounded-lg border border-slate-200/80 bg-white p-2.5 shadow-lg">
